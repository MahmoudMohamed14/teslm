...
class Chat extends StatelessWidget {
  ...
  void sendMessage() {
    ...
    if (message.isNotEmpty) {
      ChatControllerCubit().postMessage(message: message, chatId:'ab0d6bc4-9066-49bc-bfbc-ae3d5bacad13');
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ChatControllerCubit, ChatControllerState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(title: Center(child: Text(language=='English Language'?'Call Center':'خدمة العملاء',style: TextStyle(fontWeight: FontWeight.w500),)),elevation: 0,
              leading: BackButton(
                onPressed: () {
                  Navigator.of(context).pop();},
              ),
            ),
            body:  state is !GetChatCallCenterLoading&&message!=null? Column(
              children: [
                Expanded(
                  child: Padding(
