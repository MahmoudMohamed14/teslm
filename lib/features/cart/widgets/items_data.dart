                ...
                BlocConsumer<ProviderCubit,ProviderState>(
                    ...
                    children: [
                      addOrRemoveOne(
                          ...
                          context,
                              (){ ProviderCubit.get(context).addValue(values[index]['name'],1,values[index]['image'],values[index]['price'],values[index]['itemId'],values[index]['description'],values[index]['extraId']);},
