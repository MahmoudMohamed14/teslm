                ...
                Row(
                  ...
                  children: [
                    addOrRemoveOne(
                        ...
                        context,
                            (){ DeliveryCubit.get(context).addValue(values[index]['name'],1,values[index]['image'],values[index]['price'],values[index]['id'],values[index]['description'],values[index]['extraId']);},
