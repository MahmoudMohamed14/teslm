      ...
      child: Container(
        ...
        child: Card(
          ...
          child: Row(
            ...
            children: [
              image(
                  '${values[index]['image']}', 120.0, 119.0, 10.0, BoxFit.fill),
              Expanded(
                  child: Padding(
                    ...
                    BlocConsumer<ProviderCubit, ProviderState>(
                        ...
                        builder: (context, state) {
                          return Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              addOrRemoveOne(values[index]['quantity'], context,
                                  () {
                                ProviderCubit.get(context).addValue(
                                    ...
                                    values[index]['itemId'],
                                    values[index]['description'],
                                    values[index]['extraId'],
                                    values[index]['ProviderId']);
                              }, () {
                                ProviderCubit.get(context).minusValue(
                                    values[index]['name'],
                                    1,
                                    values[index]['image'],
                                    values[index]['price'],
