...
Widget addOrRemoveOne(itemsNumber,context,add,remove,mainPage)=>Container(
  ...
  child: Row(
    ...
    children: [
      ...
      InkWell(onTap: remove,child:itemsNumber==1&&mainPage==false?const Icon(Icons.restore_from_trash_outlined,color: Colors.white,):const Icon(Icons.remove,color: Colors.white,),),
    ],
  ),
);